...
file_getter.retrieve("https://atom-installer.github.com/v1.21.0/atom-mac.zip?s=1506980957&ext=.zip, https://atom.io/", '%s/%s' % (software_directory, 'atom.zip'))
file_getter.retrieve("https://drive.google.com/uc?export=download&id=0B6sXhzvUFztFdFctX1M2ZDZBanc", '%s/%s' % (software_directory, 'bin.zip'))#need to store this somewhere for direct download
